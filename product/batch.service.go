...
// Old way of decrementing / incrementing batches flow
// get batch by sku (database call)
// convert unit (unit service -> database call)
// update batch (database call)
// create transaction (transaction service -> database call)
// get recipe (database call)
// convert unit (unit service -> database call)
// update batch (database call) (O(n) where n is number of recipes)
// create transaction (transaction service -> database call) (O(n) where n is number of recipes)
// complexity = O(N*M) where N is number of recipes and M is number of batches to decrement / increment

// New way of decrementing / incrementing batches flow
// get recipes (database call)
// add all the batches to decrement / increment (O(n) where n is number of recipes)
// get all the unit conversions as a map[unitId]conversion
// get all the original units as a map[sku]unitId

// func (s *BatchService) getShouldDecrementRecipe(ctx context.Context) bool {

// }

// func (s *BatchService) getRecipesBatchInputUsingSku(ctx context.Context, sku string) []BatchInput {

// }

// func (s *BatchService) batchConversionMap(ctx context.Context, inputs []BatchInput) (map[string]BatchInput, error) {
// }
...
// func (s *BatchService) BulkIncrementBatch(ctx context.Context, input []BatchInput) error {

// }

// func (s *BatchService) bulkIncrementBatch(ctx context.Context, input []BatchInput) error {
// 	// get all batch bases (database call)
// 	// get all unit conversions (database call)
// 	// get all original units (database call)
// 	// convert all batch inputs (O(n) where n is number of batch inputs) using unit conversions and original units
// 	// update batches (database call) (O(n) where n is number of batch inputs)
// 	// create transactions (database call) (O(n) where n is number of batch inputs)
// 	// complexity = O(N) where N is number of batch inputs
// }
...
// func (s *BatchService) BulkDecrementBatch(ctx context.Context, input []BatchInput) error {
